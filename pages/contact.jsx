			...
			<section className={styles.first}>
				<div className={styles['first-content']}>
					...
					<p className={styles.sub}>
						The Motion (Mobile Innovation) Laboratory is one of the research laboratories under shelter in

						Under the Faculty of Informatics, Telkom University. Motion Lab focuses on the creation and development of mobile software. Until now, Motion Lab has come up with 3 division options, namely Business Analyst, UI/UX Design, and Mobile Programming.
					</p>
