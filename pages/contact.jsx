			...
			<section className={styles.first}>
				<div className={styles['first-content']}>
					...
					<p className={styles.sub}>
						We&#39;d love to hear from you. Wheter you&#39;re curious more about Mobile Innovation Laboratory, we&#39;re ready to answer any and all your questions,
						just contact us on DM Instagram <a href="https://www.instagram.com/motionlab_/" target="_blank" rel="noopener noreferrer">@motionlab_</a>
						<br /><br />
			...
			<section className={styles.second}>
				...
				<div className={styles['second-social']}>
					<div className={styles.social}>
						<a
							target="_blank"
							href="https://liff.line.me/1645278921-kWRPP32q?accountId=biy7493e#mst_challenge=B1ZDBAp9rbyTWPF3iAJ2k1b65qumuPvzH1IvhbvmgZM"
					...
					<div className={styles.social}>
						<a
							target="_blank"
							href="https://www.linkedin.com/company/motion-laboratory/"
							rel="noopener noreferrer"
						>
							<Image
