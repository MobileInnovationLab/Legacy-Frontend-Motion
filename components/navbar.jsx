    ...
    <>
      <nav
        className={`${styles["navbar-main"]} ${
          (navbar || navModals) && styles["active"]
        }`}
      >
        <div className={styles["flex-container"]}>
                      ...
                      className={`${styles["nav-item"]} ${
                        styles[
                          `${
                            ...
                            nav?.dropDown?.find(
                              (navItem) => navItem.href == router.pathname
                            )
                              ? "active"
                              : ""
                          }`
          ...
          <button
            className={`${styles["button-change"]} ${
              navModals && styles.inactive
            }`}
            onClick={() => setNavModals(true)}
          >
            <svg
              width="32"
              height="32"
          ...
          <button
            className={`${styles.exit} ${navModals && styles.active}`}
            onClick={() => setNavModals(false)}
          >
            <svg
              width="28"
              height="29"
      ...
      <div
        className={`${styles["bg-nav-inactive"]} ${navModals && styles.active}`}
        onClick={() => setNavModals(false)}
      />
    </>
  );
