...
import styles from "@/core/styles/pages/contactUs.module.scss";
...
const contact = () => {
  return (
    <div className={styles["bg-color"]}>
      <GeneralSeo
        title="Contact Us"
        description="Have Any Question? We'd love to hear from you. Wheter you're curious more about Mobile Innovation Laboratory, we're ready to answer any and all your questions"
      />
      <Navbar />
      ...
      <section className={styles.first}>
        <div className={styles["first-content"]}>
          ...
          <p className={styles.sub}>
            We&#39;d love to hear from you. Wheter you&#39;re curious more about
            Mobile Innovation Laboratory, we&#39;re ready to answer any and all
            your questions, just contact us on DM Instagram{" "}
            <a
