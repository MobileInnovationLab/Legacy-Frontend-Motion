...
export default function HomeView() {
  ...
  return (
    <div className={styles["main-bg"]}>
      ...
      {ytModal ? (
        <motion.div className={styles["whole-page"]} onClick={closeYtModals} initial={ytModal ? { opacity: 0 } : { opacity: 1 }} animate={ytModal ? { opacity: 1 } : { opacity: 0 }} transition={{ type: "spring", duration: 2, bounce: 0 }}>
          <div className={styles["main-container"]}>
            <div className={styles.container}>
              <iframe className={styles.responsiveYt} src="https://www.youtube.com/embed/vI64lbga0FY" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
            </div>
          </div>
        </motion.div>
      ) : (
      ...
      <div className={styles["main-body"]}>
        <main className={styles["box-first-section"]}>
          <motion.article className={styles["first-section-article"]} initial={{ y: "10px", opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ type: "spring", duration: 2, bounce: 0 }}>
            <h1 className={styles["first-section-title"]}>Mobile Innovation Laboratory</h1>
            <p className={styles["first-section-p"]}>The Mobile Innovation Laboratory, or commonly called Motion Lab, is one of the latest laboratories at the Faculty of Informatics, Telkom University under the auspices of K-Side.</p>
            <motion.a className={styles["first-section-button"]} onClick={openYtModals} whileHover={{ scale: 1.05 }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="12" cy="12" r="12" fill="white" />
                <path d="M15.0871 12.754C15.0494 12.7927 14.9072 12.958 14.7747 13.094C13.9979 13.9493 11.9716 15.3493 10.9111 15.7767C10.75 15.8453 10.3428 15.9907 10.1252 16C9.91675 16 9.71802 15.952 9.52838 15.8547C9.29198 15.7187 9.10233 15.5047 8.99842 15.252C8.93153 15.0767 8.82761 14.552 8.82761 14.5427C8.7237 13.9687 8.66655 13.036 8.66655 12.0053C8.66655 11.0233 8.7237 10.1287 8.80878 9.546C8.81852 9.53667 8.92244 8.88467 9.03609 8.66133C9.24457 8.25333 9.65177 8 10.0876 8H10.1252C10.409 8.01 11.0059 8.26333 11.0059 8.27267C12.0093 8.70067 13.9888 10.032 14.7844 10.9167C14.7844 10.9167 15.0085 11.144 15.1059 11.286C15.2579 11.49 15.3332 11.7427 15.3332 11.9953C15.3332 12.2773 15.2481 12.54 15.0871 12.754" fill="#F82F1E" />
              </svg>
              Watch Video
            </motion.a>
          </motion.article>

          <motion.div className={styles["first-section-img"]} initial={{ y: "10px", opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ type: "spring", duration: 2, bounce: 0 }}>
            <IndexIllustration />
          </motion.div>
        </main>
        ...
        <section className={styles["box-third-section"]}>
          ...
          <div className={styles["third-section-right"]}>
            <Carousel infinite={true} responsive={responsive} arrows={false} autoPlay={true}>
        ...
        <section className={styles["box-fourth-section"]}>
          ...
          <div className={styles["fourth-gallery"]}>
            <div className={styles["fifth-slider-item"]}>
              <IndexAchievementContainer id={"ach.id"} title={"ach.name"} team={"ach.team_name"} image={`https://images.unsplash.com/photo-1683009426952-13567b4fa28b?auto=format&fit=crop&q=80&w=3719&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D`} />
            </div>
            <div className={styles["fifth-slider-item"]}>
              <IndexAchievementContainer id={"ach.id"} title={"ach.name"} team={"ach.team_name"} image={`https://images.unsplash.com/photo-1683009426952-13567b4fa28b?auto=format&fit=crop&q=80&w=3719&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D`} />
            </div>
        ...
        <section className={styles["box-fifth-section"]}>
          ...
          <div className={styles["fifth-bottom"]}>
            <Carousel infinite={true} responsive={blogSliderResponsive} arrows={false} autoPlay={true}>
              <div className={styles["fifth-slider-item"]}>
                <BlogContainer
                  id={"blog.id"}
                  image={{
