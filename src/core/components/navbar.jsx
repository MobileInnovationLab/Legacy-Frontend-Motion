          ...
          <div className={styles["container"]}>
            <div className={styles["navbar-img-white"]}>
              <Link href="" passHref legacyBehavior>
                <Image src="/navbar/logo-white-transparent.png" alt="Motion Logo" layout="fill" objectFit="cover" />
              </Link>
            </div>
            <div className={styles["navbar-img-red"]}>
              <Link href="" passHref legacyBehavior>
                <Image src="/navbar/logo-red-transparent.png" alt="Motion Logo" layout="fill" objectFit="cover" />
              </Link>
            </div>
              ...
              {navs.map((nav) => (
                <li className={styles["style-hover"]} key={nav.text}>
                  ...
                  <Link href={nav.href} legacyBehavior>
                    <a className={`${styles["nav-item"]} ${styles[`${pathname == nav.href || nav?.dropDown?.find((navItem) => navItem.href == pathname) ? "active" : ""}`]}`}>{nav.text}</a>
                  </Link>
                  {/* dropdown */}
                  {"dropDown" in nav && (
                      ...
                      {nav.dropDown.map((navHover) => (
                        <>
                          <li key={`${navHover.text}-li`}>
                            <Link href={navHover.href} legacyBehavior>
                              <a>{navHover.text}</a>
                            </Link>
                          </li>
